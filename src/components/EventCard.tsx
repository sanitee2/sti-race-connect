...
export function EventCard({ 
  ...
  if (showRegistration && isAuthenticated) {
    return (
      <div className="group relative bg-card rounded-xl overflow-hidden transition-all hover:shadow-lg border border-border hover-scale hover:border-primary/30">
